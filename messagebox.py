...
class Messagebox:
    ...
    def attack_npc(self, damage, npc, colours):
        ...
        if colours.beautiful_colours:
            ...
            self.new_message = Message(message, len(message) - 2 * len(colours.get_colour("yellow")) - 4 *
    ...
    def attack_player(self, player, npc, damage, colours):
        if colours.beautiful_colours:
            ...
            self.new_message = Message(message, len(message) - len(colours.get_colour("yellow")) - 3 *
                                       len(colours.get_colour("white")) - 2 * len(colours.get_colour("red")))
        else:
    ...
    def npc_death(self, colours, npc):
        if colours.beautiful_colours:
            ...
            self.new_message = Message(message, len(message) - len(colours.get_colour("cyan")) -
    ...
    def player_death(self, colours):
        if colours.beautiful_colours:
            ...
            self.new_message = Message(message, len(message) - len(colours.get_colour("red")) -
                                       len(colours.get_colour("white")))
        else:
